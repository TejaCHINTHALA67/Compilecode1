...
router.get("/:id", optionalAuth, async (req, res) => {
  try {
    const startup = await Startup.findById(req.params.id)
      .populate(
        "founder",
        "firstName lastName profilePicture bio entrepreneurProfile communityScore"
      )
      .populate("coFounders.user", "firstName lastName profilePicture")
...
router.post(
  ...
  [
    ...
    body("tagline")
      ...
      .withMessage("Tagline must be between 10 and 200 characters"),
    body("description")
      .trim()
    ...
    body("businessModel")
      .isIn(["B2B", "B2C", "B2B2C", "Marketplace", "SaaS", "Hardware", "Other"])
  ...
  async (req, res) => {
    try {
      ...
      const populatedStartup = await Startup.findById(startup._id).populate(
        "founder",
...
router.post(
  ...
  [
    ...
    body("milestone")
      .optional()
      .isIn(["funding", "product", "team", "partnership", "customer", "other"])
